...
if (exclude) {
	run("Analyze Particles...", "size=&minarea-&maxarea circularity=&mincirc-1.00 exclude overlay add");
} else {
	run("Analyze Particles...", "size=&minarea-&maxarea circularity=&mincirc-1.00 overlay add");	
}
